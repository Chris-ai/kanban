...
const BoardButtonElement: React.FC<BoardButtonElementProps> = ({board, changeBoard, className}) => {
    return (
        <Button appearance={'transparent'} onClick={changeBoard} className={'flex items-center flex-nowrap gap-3 pl-6 py-3.5 rounded-r-full w-[220px] group/element sm:hover:bg-main-purple duration-300 transition ease-in-out'}>
